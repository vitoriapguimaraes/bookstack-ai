            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col" style={{ height: getDynamicHeight(dataLidos) }}>
                    <p className="text-sm font-medium text-slate-500 dark:text-neutral-500 mb-4 flex justify-between uppercase tracking-widest flex-shrink-0">
                        <span>Lidos</span>
                        <span className="text-slate-700 dark:text-neutral-300">{dataLidos.reduce((a, b) => a + b.value, 0)}</span>
                    </p>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            {chartType === 'pie' ? (
                                ...
                                <BarChart data={dataLidos} layout="vertical" margin={{ left: 20 }}>
                                    ...
                                    />
                                    <Bar dataKey="value" radius={[2, 2, 2, 2]} isAnimationActive={false} barSize={32} background={{ fill: 'transparent' }}>
                ...
                <div className="relative flex flex-col" style={{ height: getDynamicHeight(dataNaoLidos) }}>
                    ...
                    <p className="text-sm font-medium text-slate-500 dark:text-neutral-500 mb-4 flex justify-between uppercase tracking-widest pl-0 md:pl-6 flex-shrink-0">
                        <span>Não Lidos</span>
                        <span className="text-slate-700 dark:text-neutral-300">{dataNaoLidos.reduce((a, b) => a + b.value, 0)}</span>
                    </p>
