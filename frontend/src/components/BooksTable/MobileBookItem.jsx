...
export default function MobileBookItem({
  ...
  return (
    <div
      className={`bg-white dark:bg-neutral-900 rounded-lg p-3 border ${
        isSelected
          ? "border-purple-500 ring-1 ring-purple-500"
          : "border-slate-200 dark:border-neutral-800"
      } shadow-sm flex gap-3 relative transition-all active:scale-[0.99]`}
    >
      ...
      <div className="shrink-0 w-16 h-24 bg-slate-100 dark:bg-neutral-800 rounded overflow-hidden relative">
        ...
        <div
          className={`absolute bottom-0 left-0 right-0 text-[9px] font-bold text-center py-0.5 
              ${
                book.status === "Lendo"
        ...
        <div>
          <div className="flex justify-between items-start gap-2">
            ...
            <button
              ...
              className="text-slate-400 hover:text-red-500 p-1 -mt-1 -mr-2"
            >
              <Trash2 size={16} />
            </button>
          </div>
